...
Persephone 프로젝트를 소개하고 연구 내용, 팀 정보, 데이터 시각화, 문의 기능을 사용자에게 제공하기 위해 제작한 프론트엔드 사이드 프로젝트입니다.

## Features

프론트엔드는 React + SCSS 기반으로 구성되었으며, 사용자가 프로젝트 정보를 쉽게 탐색할 수 있도록 페이지 구성과 반응형 UI를 구현했습니다.
